...
class PermissionRepository
{
    ...
    public function getPermissionByIds($permissionIds): Collection
    {
     ...
     * 創建新權限
     */
    public function createPermission($permissionData): Permission
    {
     ...
     * 批量創建權限
     */
    public function createPermissions($permissionsData): void
    {
     ...
     * 更新權限資料
     */
    public function updatePermission($permissionId, $permissionData): void
    {
    ...
    /**
     * 檢查使用者的權限模式 (含 wildcard)
     */
    public function checkUserPermissionPatterns($userId, $patterns): array
    {
