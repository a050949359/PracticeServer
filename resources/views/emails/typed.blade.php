            ...
            <tr>
                <td align="center">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border-radius:16px;padding:32px;">
                        <tr>
                            <td>
                                <p style="margin:0 0 12px;color:#0891b2;font-size:14px;font-weight:700;">PracticeServer</p>
                                ...
                                @if (! empty($actionUrl) && ! empty($actionLabel))
                                    <p style="margin:0 0 24px;">
                                        <a
                                            href="{{ $actionUrl }}"
                                            style="display:inline-block;padding:12px 20px;border-radius:12px;background:#22d3ee;color:#082f49;text-decoration:none;font-weight:700;"
                                        >
                                            {{ $actionLabel }}
                                        </a>
                                    </p>
